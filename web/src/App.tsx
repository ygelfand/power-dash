                  ...
                  styles={{
                    ...
                    indicator: {
                      ...
                      backgroundImage: isMixed
                        ? `repeating-linear-gradient(45deg, transparent, transparent 5px, ${computedColorScheme === "dark" ? "rgba(255, 255, 255, 0.1)" : "rgba(34, 139, 230, 0.1)"} 5px, ${computedColorScheme === "dark" ? "rgba(255, 255, 255, 0.1)" : "rgba(34, 139, 230, 0.1)"} 10px)`
                        : undefined,
                      boxShadow:
                        computedColorScheme === "dark"
                          ? "none"

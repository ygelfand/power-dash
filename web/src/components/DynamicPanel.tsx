...
export function DynamicPanel({ 
    ...
    height = 300, 
        ...
        const Chart = ComponentRegistry[panel.component] || ComponentRegistry["PowerFlow"];
        const showLegend = explicitShowLegend !== undefined ? explicitShowLegend : panel.showLegend;
